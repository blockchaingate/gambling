  ...
  CanvasInput.prototype = {
    ...
    click: function(e, self) {
      var mouse = self._mousePos(e),
        x = mouse.x - self._ctx.canvas.width/2,
        y = mouse.y - self._ctx.canvas.height/6;
    ...
    render: function() {
      ...
      self._drawTextBox(function() {
        ...
        if (self._ctx) {
          self._ctx.clearRect(self._x, self._y-self._ctx.canvas.height/3, ctx.canvas.width, ctx.canvas.height);
          self._ctx.drawImage(self._renderCanvas, self._x, self._y-self._ctx.canvas.height/3);
        }
